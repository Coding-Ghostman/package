...
exports.BaseChatRequest = void 0;
...
(function (BaseChatRequest) {
    function getJsonObj(obj) {
        ...
        if (obj && "apiFormat" in obj && obj.apiFormat) {
            switch (obj.apiFormat) {
                ...
                case "COHERE":
                    return model.CohereChatRequest.getJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.apiFormat}`);
            }
        }
        return jsonObj;
    }
    BaseChatRequest.getJsonObj = getJsonObj;
    function getDeserializedJsonObj(obj) {
        ...
        if (obj && "apiFormat" in obj && obj.apiFormat) {
            switch (obj.apiFormat) {
                ...
                case "COHERE":
                    return model.CohereChatRequest.getDeserializedJsonObj(jsonObj, true);
                default:
                    if (common.LOG.logger)
                        common.LOG.logger.info(`Unknown value for: ${obj.apiFormat}`);
            }
    ...
    BaseChatRequest.getDeserializedJsonObj = getDeserializedJsonObj;
})(BaseChatRequest = exports.BaseChatRequest || (exports.BaseChatRequest = {}));
//# sourceMappingURL=base-chat-request.js.map